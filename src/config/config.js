...
const envVarsSchema = Joi.object()
  .keys({
    ...
    POSTGRESQL_USER: Joi.string().required().description("PostgreSQL Username"),
    POSTGRESQL_PASSWORD: Joi.string().required().description("PostgreSQL Password"),
    POSTGRESQL_HOST: Joi.string().required().description("PostgreSQL Host"),
    POSTGRESQL_DBNAME: Joi.string().required().description("PostgreSQL Database Name"),
  })
  .unknown();
...
module.exports = {
  ...
  postgresql:{
    ...
    dbname: envVars.POSTGRESQL_DBNAME,
  },
  jwt: {
